...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexGian = /^\/gian/; botRegexrip = /^\/rip/; botRegexniños = /^\/niños/;
  ...
  if(request.text && botRegex.test(request.text)) {
  ...
  else if(request.text && botRegexFaggotBowl.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://i.postimg.cc/T11jRHxR/8080-B3-CC-7897-47-F5-96-A8-53-BDC56-DE49-E.jpg");
    this.res.end();
  }
  ...
  else if(request.text && botRegexskip.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://chumley.barstoolsports.com/wp-content/uploads/2019/06/14/skip-bayless-640x480.jpg");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://gph.is/1CJWpHS");
    this.res.end();
  } 
  else if(request.text && botRegexniños.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://i.postimg.cc/j5zGD1BN/3-kids-with-school-bags-and-books-2.jpg");
    this.res.end();
  } 
  else if(request.text && botRegexDL.test(request.text)) {
    this.res.writeHead(200);
    //postMessage("http://www.daddyleagues.com/maddenrating?name=&position=all&team="+request.text.substring(5,8));
    postMessage("http://daddyleagues.com/Mgawdz/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://i.postimg.cc/J4jBGzd2/IMG-0364-2.jpg");
    this.res.end();
  } 
  else if(request.text && botRegexSC.test(request.text)) {
    this.res.writeHead(200);
    
    postMessage("http://daddyleagues.com/Mgawdz/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/Mgawdz/players?name="+rep+"&position=all&team=all");
